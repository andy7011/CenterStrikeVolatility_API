...
# My orders data from SFTP
download_file_from_server(sftp_client, temp_obj.substitute(name_file='MyOrders.csv'), "local_MyOrders.csv")
with open("local_MyOrders.csv", 'r') as file:
